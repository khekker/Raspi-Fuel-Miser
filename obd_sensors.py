...
def maf(code):
    ...
    #return code * 0.00132276 removed conversion factor to go back to gr/s
	return code
...
def speed(code):
	code = hex_to_int(code)
    #return code / 1.609 removed conversion factor to go back to km/h
	return code
...
SENSORS = [
    ...
    Sensor("maf"                   , "     Air Flow Rate (MAF)", "0110", maf              ,"gr/s" ),
